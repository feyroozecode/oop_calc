...
namespace Application{
    class Calculator {
        ...
        private static readonly string pattern2 = @"(\d+\.?\d*)|([+-/*()])";
        ...
        public static void mainLoop(){
            ...
            while (parcourir)
            {
                Fun.affiche("Entrer des insctruction pour calculer ou cliquer sur q pour quitter");
        ...
        public static void launchCalc(String input){
                ...
                // TODO Verfy data before convert it 
